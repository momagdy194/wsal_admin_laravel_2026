...
<head>
    <meta charset="utf-8">
    <title>Driver Dashboard Report</title>
    <style>
        ...
        .summary-table td:first-child { font-weight: bold; width: 50%; }
    </style>
</head>
<body>
    <h1>Driver Dashboard Report</h1>
    ...
    <table>
        <thead><tr><th>#</th><th>Driver name</th><th>Trips (last 30 days)</th></tr></thead>
        <tbody>
    ...
    <table>
        <thead><tr><th>#</th><th>Driver name</th><th>Earnings (last 30 days)</th></tr></thead>
        <tbody>
