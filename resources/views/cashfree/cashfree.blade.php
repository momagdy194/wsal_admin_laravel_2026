               ...
               <div class="col-12 col-md-6 mb-3">
                    ...
                    <div class="center">
                         ...
                         <form action="{{ route('store') }}" method="POST">
                              @csrf
                              <img src="{{ asset('build/assets/cashfree-3110329a.png')}}" class="img-fluid"> 
                               <h1>{{$payment->currency}} {{$payment->amount}}</h1><br>
                              <input type="hidden" class="form-control" name="transaction_id" id="transaction_id" value="{{ $payment->id }}" placeholder="transaction_id">
