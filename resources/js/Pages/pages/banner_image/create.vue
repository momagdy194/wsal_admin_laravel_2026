...
export default {
  ...
  setup(props) {
    const { t } = useI18n();
    const useImageUrl = ref(!!props.bannerimage?.image_url);

    const form = useForm({
      image: props.bannerimage ? props.bannerimage.image || "" : "",
      image_url: props.bannerimage?.image_url || "",
    });
    ...
    const previewImage = computed(() => {
      if (useImageUrl.value && form.image_url) {
        return form.image_url; // show pasted URL image
      }
      return typeof form.image === "string" ? form.image : null; // static image
    });
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="mb-3">
                      ...
                      <ImageUpload  :imageType="'banner'" :flexStyle="'0 0 min(500px ,100%)'" :aspectRatio="'5 / 1'"   :initialImageUrl="form.image"  
