...
export default {
  ...
  setup(props) {
    ...
    const form = useForm({
      header_logo: props.singlelandingHeader ? props.singlelandingHeader.header_logo || "" : "",
      home: props.singlelandingHeader ? props.singlelandingHeader.home || "" : "",
      aboutus: props.singlelandingHeader ? props.singlelandingHeader.aboutus || "" : "",
      apps: props.singlelandingHeader ? props.singlelandingHeader.apps || "" : "",
      contact: props.singlelandingHeader ? props.singlelandingHeader.contact || "" : "",
      book_now_btn: props.singlelandingHeader ? props.singlelandingHeader.book_now_btn || "" : "",
      footer_logo: props.singlelandingHeader ? props.singlelandingHeader.footer_logo || "" : "",
      footer_para: props.singlelandingHeader ? props.singlelandingHeader.footer_para || "" : "",
      quick_links: props.singlelandingHeader ? props.singlelandingHeader.quick_links || "" : "",
      compliance: props.singlelandingHeader ? props.singlelandingHeader.compliance || "" : "",
      privacy: props.singlelandingHeader ? props.singlelandingHeader.privacy || "" : "",
      terms: props.singlelandingHeader ? props.singlelandingHeader.terms || "" : "",
      dmv: props.singlelandingHeader ? props.singlelandingHeader.dmv || "" : "",
      user_app: props.singlelandingHeader ? props.singlelandingHeader.user_app || "" : "",
      user_play: props.singlelandingHeader ? props.singlelandingHeader.user_play || "" : "",
      user_play_link: props.singlelandingHeader ? props.singlelandingHeader.user_play_link || "" : "",
      user_apple: props.singlelandingHeader ? props.singlelandingHeader.user_apple || "" : "",
      user_apple_link: props.singlelandingHeader ? props.singlelandingHeader.user_apple_link || "" : "",
      driver_app: props.singlelandingHeader ? props.singlelandingHeader.driver_app || "" : "",
      driver_play: props.singlelandingHeader ? props.singlelandingHeader.driver_play || "" : "",
      driver_play_link: props.singlelandingHeader ? props.singlelandingHeader.driver_play_link || "" : "",
      driver_apple: props.singlelandingHeader ? props.singlelandingHeader.driver_apple || "" : "",
      driver_apple_link: props.singlelandingHeader ? props.singlelandingHeader.driver_apple_link || "" : "",
      copy_rights: props.singlelandingHeader ? props.singlelandingHeader.copy_rights || "" : "",
      fb_link: props.singlelandingHeader ? props.singlelandingHeader.fb_link || "" : "",
      linkdin_link: props.singlelandingHeader ? props.singlelandingHeader.linkdin_link || "" : "",
      x_link: props.singlelandingHeader ? props.singlelandingHeader.x_link || "" : "",
      insta_link: props.singlelandingHeader ? props.singlelandingHeader.insta_link || "" : "",
      locale: props.singlelandingHeader ? props.singlelandingHeader.locale || "" : "",
      language: props.singlelandingHeader ? props.singlelandingHeader.language || "" : "",
    });
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        let response;
        if (props.singlelandingHeader && props.singlelandingHeader.id) {
          response = await axios.post(`/single-landing-header/update/${props.singlelandingHeader.id}`, formData, {
            headers: {
          ...
          response = await axios.post('/single-landing-header/store', formData, {
            headers: {
              'Content-Type': 'multipart/form-data',
            },
          });
        ...
        if (response.status === 201) {
          ...
          form.reset();
          router.get('/single-landing-header');
        } else {
    ...
    const fetchStoredLanguages = async () => {     
      try {
        const response = await axios.get('/single-landing-header/list');
    ...
    return {
      ...
      errors,
      validateIconSize,
      singlelandingHeader: props.singlelandingHeader,
      iconUrl,
      handleImageSelected,
      handleImageRemoved,
      languages,
...
<template>
  <Layout>
    ...
    <PageHeader :title="singlelandingHeader ? $t('edit') : $t('create')" :pageTitle="$t('single_landingSite_header_footer')" pageLink="/landing-header"/>
    <BRow>
            ...
            <form @submit.prevent="handleSubmit">
              <FormValidation :form="form" :rules="validationRules" ref="validationRef">
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label for="apps" class="form-label">{{$t("apps")}}
                        <span class="text-danger">*</span>
                      </label>
                      <input type="text" :readonly="app_for === 'demo'" class="form-control" :placeholder="$t('enter_hero_title')" id="apps" v-model="form.apps" />
                      <span v-for="(error, index) in errors.apps" :key="index" class="text-danger">
                        {{ error }}
                      </span>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="text-end">
                      <button type="submit" class="btn btn-primary">{{ singlelandingHeader ? $t('update') : $t('create') }}</button>
                    </div>
                  </div>
                </div>
              </FormValidation>
