...
<template>
    ...
    <body id="bodyContainer">
        ...
        <div class="container-fluid" role="main" aria-label="Admin sign in">
            <BRow>
                <BCol lg="5">
                    <div class="form_field text-white">
                        <Bcard>
                            <BCardBody class="BcardBody">
                                <h1 class="display-6" style="color: white;" id="admin-signin-heading"><b>Admin Signin</b></h1>
                                <p class="">Welcome back login to your panel.</p>
                                <div class="mt-5">
                                    <form @submit.prevent="submit" aria-labelledby="admin-signin-heading" aria-describedby="admin-signin-errors">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <InputError id="email-error" :message="form.errors.email" role="alert" />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input :type="togglePassword ? 'text' : 'password'" class="form-control pe-5 p-3"
                                                ...
                                                autocomplete="current-password" required :class="{ 'is-invalid': form.errors.password }"
                                            ...
                                            >
                                                <i class="ri-eye-fill align-middle ri-lg" aria-hidden="true"></i>
                                            </BButton>
                                            <InputError id="password-error" :message="form.errors.password" role="alert" />
                                        </div>
                                    </div>
                                    <div id="admin-signin-errors" aria-live="polite" class="sr-only"></div>
                                        <div class="float-end " >
                                        ...
                                        <div class="credential-panel credential-row" v-if = "appFor === 'demo'" >
                                            ...
                                            <div class="col">
                                                <div class="credential-item">
                                                    ...
                                                    <span class="value" id="display-email">admin@admin.com</span>
                                                </div>
                                            </div>
                                            <!-- Password row -->
                                            <div class="col">
