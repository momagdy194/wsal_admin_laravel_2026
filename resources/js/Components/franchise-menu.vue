      ...
      <ul class="navbar-nav h-100 mt-5" id="navbar-nav">
        <div  class="menu">
          <li class="nav-item mt-4">
            <Link class="nav-link menu-link" href="/individual-franchiseowner-dashboard" v-if="permissions.includes('access-franchise-owner-dashboard')">
                <i class=" ri-home-4-line"></i> <span data-key="t-dashboard">{{ $t("dashboard") }}</span>
            </Link>
          </li>
          <li class="nav-item mt-4">
            <Link class="nav-link menu-link" href="/franchise/withdrawal-request" v-if="permissions.includes('franchise-withdrawal-request')" >
                <i class="ri-wallet-3-line"></i> <span data-key="t-dashboard">{{ $t("withdrawal") }}</span>
            </Link>
          </li>
      </div>
    </ul>
