...
<template>
            <footer class="custom-footer py-5 position-relative"    style="background-color: var(--single_landing_footer_bg_color); color: var(--single_landing_footer_text);">
            <BContainer>
                <BRow>
                    <BCol lg="4" class="mt-4">
                        <div>
                            ...
                            <div class="mt-4 fs-13" style="color:var(--single_landing_footer_text_color);">
                    ...
                    <BCol lg="7" class="ms-lg-auto">
                        <BRow>
                            <BCol sm="4" class="mt-4">
                                <h5 class=" mb-0" style="color:var(--single_landing_footer_text_color);">{{ headers.quick_links }}</h5>
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li>
                                            <Link style="color:var(--single_landing_footer_text_color);" href="/compliance">{{ headers.compliance }}</Link>
                                        </li>
                                        <li>
                                            <Link style="color:var(--single_landing_footer_text_color);" href="/privacy">{{ headers.privacy }}</Link>
                                        </li>
                                        <li>
                                            <Link style="color:var(--single_landing_footer_text_color);" href="/terms">{{ headers.terms }}</Link>
                                        </li>
                                        <li>
                                            <Link style="color:var(--single_landing_footer_text_color);" href="/dmv">{{ headers.dmv }}</Link>
                                        </li>
                                    </ul>
                                </div>
                            </BCol>
                            <BCol sm="4" class="mt-4">
                                <h5 class="mb-0" style="color:var(--single_landing_footer_text_color);">{{ headers.user_app }}</h5>
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li>
                                            <BLink :href="headers.user_play_link" target="_blank" style="color:var(--single_landing_footer_text_color);">
                                                <i class="ri-google-play-fill align-middle mx-1"></i>{{ headers.user_play }}</BLink>
                                        </li>
                                        <li>
                                            <BLink :href="headers.user_apple_link" target="_blank" style="color:var(--single_landing_footer_text_color);">
                            ...
                            <BCol sm="4" class="mt-4">
                                <h5 class="mb-0" style="color:var(--single_landing_footer_text_color);">{{ headers.driver_app }}</h5>
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li>
                                            <BLink :href="headers.driver_play_link" target="_blank" style="color:var(--single_landing_footer_text_color);">
                                                <i class="ri-google-play-fill align-middle mx-1"></i>{{ headers.driver_play }}</BLink>
                                        </li>
                                        <li>
                                            <BLink :href="headers.driver_apple_link" target="_blank" style="color:var(--single_landing_footer_text_color);">
...
.footer-social-link .avatar-title {
    color: var(--single_landing_footer_text_color);
    background-color: var(--single_landing_header_act_text); 
...
.custom-footer{
 background-image: 
    linear-gradient(rgba(225,225,225,0.05) 1px, transparent 1px),
    linear-gradient(90deg, rgba(225,225,225,0.05) 1px, transparent 1px);
...
.custom-footer h5,
.custom-footer a {
    color: var(--single_landing_footer_text) !important;
}
.footer-social-link .avatar-title {
    color: #ffffff;
