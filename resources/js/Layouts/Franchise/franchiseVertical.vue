...
import NavBar from "@/Components/franchise-nav-bar.vue";
import Menu from "@/Components/franchise-menu.vue";
import RightBar from "@/Components/right-bar-franchise.vue";
import Footer from "@/Components/franchiseFooter.vue";
