...
use App\Models\Admin\VehicleTypeTranslation;
...
class VehicleType extends Model
{
     ...
     */
    protected $fillable = [
         'name', 'icon', 'capacity','is_accept_share_ride','active','company_key',
         'description','supported_vehicles','short_description','size',
         'is_taxi', 'icon_types_for','trip_dispatch_type'
    ];
    ...
    protected $searchable = [
        ...
        'columns' => [
            ...
            'vehicle_types.icon_types_for' => 20,
        ],
    ...
    /**
     * The translation that the type has.
     * @tested
     *
     * @return \Illuminate\Database\Eloquent\Relations\hasMany
     */
    public function vehicleTypeTranslationWords(){
        return $this->hasMany(vehicleTypeTranslation::class, 'vehicle_type_id', 'id');
    }
    /**
    ...
    */
    ...
    public function subVehicleTypeDetail()
    {
        return $this->hasMany(SubVehicleType::class, 'vehicle_type_id', 'id');
    }
}
