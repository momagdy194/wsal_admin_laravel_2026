...
{
    use HasActive, UuidModel,SearchableTrait,HasActiveCompanyKey,HasSpatial;
    ...
    protected $casts = [
        'spatialFields' => MultiPolygon::class,
    ];
    ...
    public function getConvertedUpdatedAtAttribute()
    {
     ...
     /**
        ...
        public function getConvertedStartTimeAttribute()
        {
            ...
            $timezone = $this->zoneDetail->serviceLocation->timezone ?: config('app.timezone');
