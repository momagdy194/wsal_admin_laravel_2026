...
/* Referral Management */
    ...
    const REFERRAL_DASHBOARD_VIEW = 'referral-dashboard-view';  
    const DRIVER_REFERRAL_SETTINGS_VIEW = 'driver-referral-settings-view';
    const REFERRAL_TRANSLATION_VIEW = 'referral-transaltion-view';
/* Agent Management */
   const AGENT_MANAGEMENT = 'agent-management';
   const VIEW_AGENTS = 'view-agents';
   const CREATE_AGENTS = 'create-agents';
   const EDIT_AGENTS = 'edit-agent';
   const DELETE_AGENTS = 'delete-agent';
   const TOGGLE_AGENTS = 'toggle-agent';
   const AGENT_VIEW_PROFILE = 'agent-view-profile';
   const VIEW_AGENT_COMMISSION = 'agent-commission-view';
   const ADD_AGENT_COMMISSION = 'add-agent-commission';
   const EDIT_AGENT_COMMISSION = 'edit-agent-commission';
   const DELETE_AGENT_COMMISSION = 'delete-agent-commission';
...
const DISPATHCER_SCHEDULED_RIDES = 'dispatcher-scheduled-rides';
const DISPATHCER_REQUEST_ENQUIRY = 'dispatcher-request-enquiry';
const DISPATHCER_REQUEST_ENQUIRY_BOOKING = 'dispatcher-request-enquiry-booking';
const DISPATHCER_REQUEST_ENQUIRY_CANCEL = 'dispatcher-request-enquiry-cancel';
const DISPATHCER_CHAT = 'dispatcher-chat';
    ...
    const UPLOAD_BULK_FILE = 'upload_bulk_file';
    const DOWNLOAD_BULK_FILE = 'download_bulk_file';
    const REUPLOAD_BULK_FILE = 'reupload_bulk_file';

    /* driver bulk upload */
    const DRIVER_BULK_UPLOAD = 'driver_bulk_upload';
    const DRIVER_UPLOAD_BULK_FILE = 'driver_upload_bulk_file';
    const DRIVER_DOWNLOAD_BULK_FILE = 'driver_download_bulk_file';
    const DRIVER_REUPLOAD_BULK_FILE = 'driver_reupload_bulk_file';

    // addons
    const ADDONS = 'addons';
    const DISPATCHER_ADDONS = 'dispathcer_addons';
    const AGENT_ADDONS = 'agent_addons';

    const OWNER_BOOKING = 'owner-booking';


    // agent
    const AGENT_DASHBOARD = 'agent-dashboard';
    const AGENT_RIDE = 'agent-ride';
    const AGENT_RIDE_REQUEST = 'agent-ride-request';
    const AGENT_ONGOING_REQUEST = 'agent-ongoing-request';

    const AGENT_RIDE_REQUEST_VIEW = 'agent-ride-request-view';
    const AGENT_ONGOING_REQUEST_VIEW = 'agent-ongoing-request-view';

    const AGENT_RIDE_REQUEST_ASSIGN = 'agent-ride-request-assign';
    const AGENT_ONGOING_REQUEST_ASSIGN = 'agent-ongoing-request-assign';

    const AGENT_RIDE_REQUEST_CANCEL = 'agent-ride-request-cancel';
    const AGENT_ONGOING_REQUEST_CANCEL = 'agent-ongoing-request-cancel';

    const AGENT_SCHEDULED_RIDES = 'agent-scheduled-rides';
    const AGENT_REQUEST_ENQUIRY = 'agent-request-enquiry';
    const AGENT_REQUEST_ENQUIRY_BOOKING = 'agent-request-enquiry-booking';
    const AGENT_REQUEST_ENQUIRY_CANCEL = 'agent-request-enquiry-cancel';
