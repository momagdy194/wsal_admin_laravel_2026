...
class ImageUploader implements ImageUploaderContract
{
    ...
    public function saveSupportImage()
    {
        $this->validateFile();

        $config = $this->config('supportticket.upload.files');
    ...
    public function saveMobileMenuImage()
    {
        ...
        $config = $this->config('mobile.upload.images');
    ...
    public function savePreferenceIcon()
    {
        ...
        $config = $this->config('preference.upload.images');
