...
use App\Jobs\AgentZipFilesAddons;


class AgentAddonsController extends Controller
{
...
//  dd($request);
        try {
            $request->validate([
                'agent_zip_file' => 'required|file|mimes:zip',
            ]);
        ...
        $uploadedFile = $request->file('agent_zip_file');
        ...
        AgentZipFilesAddons::dispatch($zipFileName, $zipFilePath);
