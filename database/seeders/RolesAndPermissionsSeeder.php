...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    //Dashboard and Configurations
       PermissionSlug::ACCESS_DASHBOARD => [
        ...
        PermissionSlug::ACCESS_FRANCHISE_OWNER_DASHBOARD => [
            'name' => 'access-franchise-owner-dashboard',
            'description' => 'Access Franchise Owner Dashboard',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => null,
            'main_link' => 'franchise-owner-dashboard',
        ],
        ...
        PermissionSlug::TOGGLE_BANNER_IMAGE => [
            ...
            'main_link'=>'banner_image',
                ...
                // manage-promotion
                PermissionSlug::MANAGE_ANNOUNCEMENT => [
                ...
                PermissionSlug::ADD_ANNOUNCEMENT => [
                    'name' => 'add-announcement',
                    'description' => 'add announcement code',
                    'main_menu'=>'promotion-management',
                    'sub_menu'=> null,
                    'sub_link'=>null,
                    'main_link'=>'announcement',
                ], 
                PermissionSlug::DELETE_ANNOUNCEMENT => [
                    'name' => 'delete-announcement',
                    'description' => 'delete announcement',
                    'main_menu'=>'promotion-management',
                    'main_link'=>'announcement',    
                ],
                PermissionSlug::TOGGLE_ANNOUNCEMENT => [
                    'name' => 'toggle-announcement',
                    'description' => 'toggle announcement',
                    'main_menu'=>'promotion-management',            
                    'sub_menu'=> null,
                    'main_link'=>'announcement',
                ], 
...
// Manage Driver Needed Doc
        ...
        PermissionSlug::REFERRAL_SETTINGS_VIEW => [
            ...
            'main_menu' => 'referral-management',
            'sub_menu' => 'referral-settings',
            'main_link' => 'referral-settings-view',
        ],
        PermissionSlug::DRIVER_REFERRAL_SETTINGS_VIEW => [
            'name' => 'driver-referral-settings-view',
            'description' => 'Referral settings view lists',
            'main_menu' => 'referral-management',
            'sub_menu' => 'driver-referral-settings',
            'main_link' => 'driver-referral-settings-view',
        ],
        PermissionSlug::REFERRAL_DASHBOARD_VIEW => [
            'name' => 'referral-dashboard-view',
            'description' => 'Referral dashboard view lists',
            'main_menu' => 'referral-management',
            'sub_menu' => 'referral-dashboard',
            'main_link' => 'referral-dashboard-view',
        ],
        PermissionSlug::REFERRAL_TRANSLATION_VIEW  => [
            'name' => 'referral-transaltion-view',
            'description' => 'referral-transaltion view lists',
            'main_menu' => 'referral-management',
            'sub_menu' => 'referral-transaltion',
            'main_link' => 'referral-transaltion-view',
        ],
...
/*Reports*/  
        ...
        PermissionSlug::FLEET_REPORT => [
         ...
         PermissionSlug::FRANCHISE_OWNER_REPORT => [
            'name' => 'franchise-owner-report',
            'description' => 'Download Franchise Report',
            'main_menu'=>'report-management',
            'sub_menu'=> null,
            'main_link'=>'franchiseowner-report',
        ],      
/* owner management */
...
/* roleS */
        ...
        PermissionSlug::DISPATHCER_ONGOING_REQUEST_ASSIGN => [
         ...
         PermissionSlug::DISPATHCER_SCHEDULED_RIDES => [
            'name' => 'dispatcher-scheduled-rides',
            'description' => 'dispatcher scheduled rides',
            'main_menu' => 'dispatcher scheduled rides ',
            'sub_menu' => null,
            'main_link' => 'dispatcher scheduled rides',
        ],
         PermissionSlug::DISPATHCER_REQUEST_ENQUIRY => [
            'name' => 'dispatcher-request-enquiry',
            'description' => 'dispatcher request enquiry',
            'main_menu' => 'dispatcher request enquiry ',
            'sub_menu' => null,
            'main_link' => 'dispatcher request enquiry',
        ],
         PermissionSlug::DISPATHCER_REQUEST_ENQUIRY_BOOKING => [
            'name' => 'dispatcher-request-enquiry-booking',
            'description' => 'dispatcher request enquiry booking',
            'main_menu' => 'dispatcher request enquiry booking',
            'sub_menu' => null,
            'main_link' => 'dispatcher request enquiry booking',
        ],
         PermissionSlug::DISPATHCER_REQUEST_ENQUIRY_CANCEL => [
            'name' => 'dispatcher-request-enquiry-cancel',
            'description' => 'dispatcher request enquiry cancel',
            'main_menu' => 'dispatcher request enquiry cancel',
            'sub_menu' => null,
            'main_link' => 'dispatcher request enquiry cancel',
        ],
          PermissionSlug::DISPATHCER_CHAT => [
            'name' => 'dispatcher-chat',
            'description' => 'dispatcher chat',
            'main_menu' => 'dispatcher chat',
            'sub_menu' => null,
            'main_link' => 'dispatcher chat',
        ],
...
/* Airport */       
         ...
         * User Bulk Upload
         * */
        PermissionSlug::BULK_UPLOAD => [
            'name' => 'bulk_upload',
            'description' => 'Bulk upload',
            'main_menu'=>'masters',
            'sub_menu'=> 'bulk_upload',
            'sub_link'=> null,
            'main_link'=>'bulk_upload',
        ],
        PermissionSlug::UPLOAD_BULK_FILE => [
            'name' => 'upload_bulk_file',
            'description' => 'upload bulk file',
            'main_menu'=>'masters',
            'sub_menu'=> 'upload_bulk_file',
            'sub_link'=> null,
            'main_link'=>'upload_bulk_file',

        ],
        PermissionSlug::DOWNLOAD_BULK_FILE => [
            'name' => 'download_bulk_file',
            'description' => 'download bulk file',
            'main_menu'=>'masters',
            'sub_menu'=> null,
            'main_link'=>'download_bulk_file',

        ],
        PermissionSlug::REUPLOAD_BULK_FILE => [
            'name' => 'reupload_bulk_file',
            'description' => 'reupload_bulk_file',
            'main_menu'=>'masters',
            'sub_menu'=> null,
            'main_link'=>'reupload_bulk_file',
         ...
         * Driver Bulk Upload
         * */
        PermissionSlug::DRIVER_BULK_UPLOAD => [
            'name' => 'driver_bulk_upload',
            'description' => 'Driver Bulk upload',
            'main_menu'=>'drivers-management',
            'sub_menu'=> 'driver_bulk_upload',
            'sub_link'=> null,
            'main_link'=>'driver_bulk_upload',
        ],
        PermissionSlug::DRIVER_UPLOAD_BULK_FILE => [
            'name' => 'driver_upload_bulk_file',
            'description' => 'driver upload bulk file',
            'main_menu'=>'drivers-management',
            'sub_menu'=> 'driver_upload_bulk_file',
            'sub_link'=> null,
            'main_link'=>'driver_upload_bulk_file',

        ],
        PermissionSlug::DRIVER_DOWNLOAD_BULK_FILE => [
            'name' => 'driver_download_bulk_file',
            'description' => 'driver download bulk file',
            'main_menu'=>'drivers-management',
            'sub_menu'=> null,
            'main_link'=>'driver_download_bulk_file',

        ],
        PermissionSlug::DRIVER_REUPLOAD_BULK_FILE => [
            'name' => 'driver_reupload_bulk_file',
            'description' => 'driver reupload_bulk_file',
            'main_menu'=>'drivers-management',
            'sub_menu'=> null,
            'main_link'=>'driver_reupload_bulk_file',

        ],

        //addons 
        PermissionSlug::ADDONS => [
            'name' => 'addons',
            'description' => 'addons',
            'main_menu'=>'addons',
            'main_link'=>'null',
        ...
        PermissionSlug::DISPATCHER_ADDONS => [
            'name' => 'dispathcer_addons',
            'description' => 'dispatcher Addons',
            'main_menu'=>'addons',
            'sub_menu'=> null,
            'main_link'=>'dispatcher_addons',
        ],
        PermissionSlug::OWNER_BOOKING => [
            'name' => 'owner-booking',
            'description' => 'owner booking',
            'main_menu'=>'owner-management',
            'sub_menu'=> null,
            'main_link'=>'owner_booking',
        ],
         // agent management //
         PermissionSlug::AGENT_MANAGEMENT => [
            'name' => 'agent-management',
            'description' => 'agent-management',
            'main_menu' => 'agent-management',
            'sub_menu' => null,
        ],
        PermissionSlug::VIEW_AGENTS => [
            'name' => 'view-agents',
            'description' => 'Get all agent',
            'main_menu'=>'agent-management',
            'sub_menu'=>null,
            'main_link'=>'view-agent',
        ],
        PermissionSlug::CREATE_AGENTS => [
            'name' => 'create-agents',
            'description' => 'create agents',
            'main_menu'=>'agent-management',
            'sub_menu'=> null,
            'main_link'=>'create-agents',
        ],        
        PermissionSlug::EDIT_AGENTS => [
            'name' => 'edit-agent',
            'description' => 'edit-agent',
            'main_menu'=>'agent-management',
            'sub_menu'=> null,
            'main_link'=>'edit-agent',
        ],       
        PermissionSlug::DELETE_AGENTS => [
            'name' => 'delete-agent',
            'description' => 'delete-agent',
            'main_menu'=>'agent-management',
            'sub_menu'=> null,
            'main_link'=>'delete-agent',
        ],
        PermissionSlug::TOGGLE_AGENTS => [
            'name' => 'toggle-agent',
            'description' => 'toggle status agents',
            'main_menu'=>'agent-management',
            'sub_menu'=> null,
            'main_link'=>'toggle-agent',
        ],
        PermissionSlug::AGENT_VIEW_PROFILE =>[
            'name' => 'agent-view-profile',
            'description' => 'agent View Profile',
            'main_menu' => 'agent-management',
            'sub_menu' => null,
            'main_link' => 'agent-view-profile'
        ],
        PermissionSlug::VIEW_AGENT_COMMISSION => [
            'name' => 'agent-commission-view',
            'description' => 'Get all agent commission',
            'main_menu'=>'agent-management',
            'sub_menu'=>null,
            'main_link'=>'agent-commission-view',
        ],
        PermissionSlug::ADD_AGENT_COMMISSION => [
            'name' => 'add-agent-commission',
            'description' => 'add agent commission',
            'main_menu'=>'agent-management',
            'sub_menu'=>null,
            'main_link'=>'add-agent-commission',
        ],  
        PermissionSlug::EDIT_AGENT_COMMISSION => [
            'name' => 'edit-agent-commission',
            'description' => 'edit agent commission',
            'main_menu'=>'agent-management',
            'sub_menu'=>null,
            'main_link'=>'edit-agent-commission',
        ],  
        PermissionSlug::DELETE_AGENT_COMMISSION => [
            'name' => 'delete-agent-commission',
            'description' => 'delete agent commission',
            'main_menu'=>'agent-management',
            'sub_menu'=>null,
            'main_link'=>'delete-agent-commission',
        ],
          // agent
        PermissionSlug::AGENT_DASHBOARD => [
            'name' => 'agent-dashboard',
            'description' => 'agent dashboard',
            'main_menu' => 'agent dashboard',
            'sub_menu' => null,
            'main_link' => 'agent dashboard',
        ],
        PermissionSlug::AGENT_RIDE => [
            'name' => 'agent-ride',
            'description' => 'agent ride',
            'main_menu' => 'agent ride',
            'sub_menu' => null,
            'main_link' => 'agent ride',
        ],
        PermissionSlug::AGENT_RIDE_REQUEST => [
            'name' => 'agent-ride-request',
            'description' => 'agent ride request',
            'main_menu' => 'agent ride request',
            'sub_menu' => null,
            'main_link' => 'agent ride request',
        ],
        PermissionSlug::AGENT_RIDE_REQUEST_VIEW => [
            'name' => 'agent-ride-request-view',
            'description' => 'agent ride request view',
            'main_menu' => 'agent ride request',
            'sub_menu' => null,
            'main_link' => 'agent ride request view',
        ],
        PermissionSlug::AGENT_RIDE_REQUEST_CANCEL => [
            'name' => 'agent-ride-request-cancel',
            'description' => 'agent ride request cancel',
            'main_menu' => 'agent ride request',
            'sub_menu' => null,
            'main_link' => 'agent ride request cancel',
        ],
        PermissionSlug::AGENT_RIDE_REQUEST_ASSIGN => [
            'name' => 'agent-ride-request-assign',
            'description' => 'agent ride request assign',
            'main_menu' => 'agent ride request',
            'sub_menu' => null,
            'main_link' => 'agent ride request assign',
        ],
        PermissionSlug::AGENT_ONGOING_REQUEST => [
            'name' => 'agent-ongoing-request',
            'description' => 'agent ongoing request',
            'main_menu' => 'agent ongoing request',
            'sub_menu' => null,
            'main_link' => 'agent ongoing request',
        ],
        PermissionSlug::AGENT_ONGOING_REQUEST_VIEW => [
            'name' => 'agent-ongoing-request-view',
            'description' => 'agent ongoing request view',
            'main_menu' => 'agent ongoing request',
            'sub_menu' => null,
            'main_link' => 'agent ongoing request view',
        ],
        PermissionSlug::AGENT_ONGOING_REQUEST_CANCEL => [
            'name' => 'agent-ongoing-request-cancel',
            'description' => 'agent ongoing request cancel',
            'main_menu' => 'agent ongoing request',
            'sub_menu' => null,
            'main_link' => 'agent ongoing request cancel',
        ],
        PermissionSlug::AGENT_ONGOING_REQUEST_ASSIGN => [
            'name' => 'agent-ongoing-request-assign',
            'description' => 'agent ongoing request assign',
            'main_menu' => 'agent ongoing request',
            'sub_menu' => null,
            'main_link' => 'agent ongoing request assign',
        ],

         PermissionSlug::AGENT_SCHEDULED_RIDES => [
            'name' => 'agent-scheduled-rides',
            'description' => 'agent scheduled rides',
            'main_menu' => 'agent scheduled rides ',
            'sub_menu' => null,
            'main_link' => 'agent scheduled rides',
        ],
         PermissionSlug::AGENT_REQUEST_ENQUIRY => [
            'name' => 'agent-request-enquiry',
            'description' => 'agent request enquiry',
            'main_menu' => 'agent request enquiry ',
            'sub_menu' => null,
            'main_link' => 'agent request enquiry',
        ],
         PermissionSlug::AGENT_REQUEST_ENQUIRY_BOOKING => [
            'name' => 'agent-request-enquiry-booking',
            'description' => 'agent request enquiry booking',
            'main_menu' => 'agent request enquiry booking',
            'sub_menu' => null,
            'main_link' => 'agent request enquiry booking',
        ],
         PermissionSlug::AGENT_REQUEST_ENQUIRY_CANCEL => [
            'name' => 'agent-request-enquiry-cancel',
            'description' => 'agent request enquiry cancel',
            'main_menu' => 'agent request enquiry cancel',
            'sub_menu' => null,
            'main_link' => 'agent request enquiry cancel',
        ],
        PermissionSlug::AGENT_CHAT => [
            'name' => 'agent-chat',
            'description' => 'agent chat',
            'main_menu' => 'agent chat',
            'sub_menu' => null,
            'main_link' => 'agent chat',
        ],
        PermissionSlug::AGENT_WALLET=> [
            'name' => 'agent-wallet',
            'description' => 'agent wallet',
            'main_menu' => 'agent wallet',
            'sub_menu' => null,
            'main_link' => 'agent wallet',
        ],
        PermissionSlug::AGENT_ADDONS => [
            'name' => 'agent_addons',
            'description' => 'agent Addons',
            'main_menu'=>'addons',
            'sub_menu'=> null,
            'main_link'=>'agent_addons',
        ],

        /* franchise owner management */
        PermissionSlug::FRANCHISE_OWNER_MANAGEMENT => [
            'name' => 'franchise-owner-management',
            'description' => 'Franchise Owner management',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => null,
            'main_link' => 'franchise-owners',
        ],
        PermissionSlug::MANAGE_FRANCHISE_DETAIL => [
            'name' => 'manage-franchise-detail',
            'description' => 'franchise details list',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'franchise-detail',
        ],
        PermissionSlug::ADD_FRANCHISE_DETAIL => [
            'name' => 'add-franchise-detail',
            'description' => 'Add franchise detail',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'add-franchise-detail',
        ],
        PermissionSlug::EDIT_FRANCHISE_DETAIL => [
            'name' => 'edit-franchise-detail',
            'description' => 'Edit franchise detail',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'edit-franchise-detail',
        ],
        PermissionSlug::DELETE_FRANCHISE_DETAIL => [
            'name' => 'delete-franchise-detail',
            'description' => 'Delete franchise detail',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'delete-franchise-detail',
        ],
        PermissionSlug::TOGGLE_FRANCHISE_DETAIL_STATUS => [
            'name' => 'toggle-franchise-detail',
            'description' => 'Toggle franchise detail Status',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'toggle-franchise-detail',
        ],
        PermissionSlug::EDIT_PASSWORD_FRANCHISE_DETAIL => [
            'name' => 'edit-password-franchise-detail',
            'description' => 'Edit password franchise detail',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-detail',
            'main_link' => 'edit-password-franchise-detail',
        ],
        PermissionSlug::MANAGE_FRANCHISE_OWNER => [
            'name' => 'manage-franchise-owners',
            'description' => 'franchise Owner list',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'franchise-owners',
        ],
        PermissionSlug::ADD_FRANCHISE_OWNER => [
            'name' => 'add-franchise-owner',
            'description' => 'Add franchise Owner',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'add-franchise-owner',
        ],
        PermissionSlug::EDIT_FRANCHISE_OWNER => [
            'name' => 'edit-franchise-owner',
            'description' => 'Edit franchise Owner',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'edit-franchise-owner',
        ],
        PermissionSlug::DELETE_FRANCHISE_OWNER => [
            'name' => 'delete-franchise-owner',
            'description' => 'Delete franchise Owner',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'delete-franchise-owner',
        ],
        PermissionSlug::TOGGLE_FRANCHISE_OWNER_STATUS => [
            'name' => 'toggle-franchise-owner',
            'description' => 'Toggle franchise Owner Status',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'toggle-franchise-owner',
        ],
        PermissionSlug::VIEW_FRANCHISE_OWNER_DOCUMENT => [
            'name' => 'view-franchise-owner-document',
            'description' => 'View franchise Owner Document',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'view-franchise-owner-document',
        ],
        PermissionSlug::VIEW_FRANCHISE_OWNER_PROFILE => [
            'name' => 'view-franchise-owner-profile',
            'description' => 'View franchise Owner Profile',
            'main_menu' => 'franchise-owner-management',
            'sub_menu' => 'manage-franchise-owners',
            'main_link' => 'view-franchise-owner-profile',
        ],
        

// Manage franchise Owner Needed Doc
        PermissionSlug::MANAGE_FRANCHISE_OWNER_NEEDED_DOC => [
        'name' => 'manage-franchise-owner-needed-document',
        'description' => 'List franchise owner needed documents',
        'main_menu'=>'franchise-owner-management',
        'sub_menu'=>null,
        'main_link'=>'manage-franchise-owner-needed-document',
        ],
        PermissionSlug::ADD_FRANCHISE_OWNER_NEEEDED_DOC => [
        'name' => 'add-franchise-owner-needed-document',
        'description' => 'Add franchise Owner needed documents',
        'main_menu'=>'franchise-owner-management',
        'sub_menu'=>null,
        'main_link'=>'add-franchise-owner-needed-document',
        ], 
        PermissionSlug::EDIT_FRANCHISE_OWNER_NEEEDED_DOC => [
        'name' => 'edit-franchise-owner-needed-document',
        'description' => 'Edit franchise Owner needed documents',
        'main_menu'=>'franchise-owner-management',
        'sub_menu'=>null,
        'main_link'=>'edit-franchise-owner-needed-document',
        ], 
        PermissionSlug::DELETE_FRANCHISE_OWNER_NEEEDED_DOC => [
        'name' => 'delete-franchise-owner-needed-document',
        'description' => 'Delete franchise Owner needed documents',
        'main_menu'=>'franchise-owner-management',
        'sub_menu'=>null,
        'main_link'=>'delete-franchise-owner-needed-document',
        ], 
        PermissionSlug::TOGGLE_FRANCHISE_OWNER_NEEEDED_DOC => [
        'name' => 'toggle-franchise-owner-needed-document',
        'description' => 'toggle franchise Owner needed document',
        'main_menu'=>'franchise-owner-management',
        'sub_menu'=>null,
        'main_link'=>'toggle-franchise-owner-needed-document',
        ],    

        // FRANCHISE DRIVER
        PermissionSlug::VIEW_FRANCHISE_PENDING_DRIVERS => [
            'name' => 'view-franchise-pending-drivers',
            'description' => 'Get-All-approval-pending-Drivers',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'view-franchise-pending-drivers',
        ],
        PermissionSlug::VIEW_FRANCHISE_APPROVED_DRIVERS => [
            'name' => 'view-franchise-approved-drivers',
            'description' => 'Get all approved drivers',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'view-franchise-approved-drivers',
        ],
        PermissionSlug::ADD_FRANCHISE_DRIVER => [
            'name' => 'add-franchise-driver',
            'description' => 'add franchise drivers',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'add-franchise-driver',
        ],
        PermissionSlug::EDIT_FRANCHISE_DRIVER => [
            'name' => 'edit-franchise-driver',
            'description' => 'edit drivers',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'edit-franchise-driver',
        ],
        PermissionSlug::DELETE_FRANCHISE_DRIVER => [
            'name' => 'delete-franchise-driver',
            'description' => 'delete franchise drivers',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'delete-franchise-driver',
        ],
        PermissionSlug::VIEW_FRANCHISE_DRIVER_PROFILE => [
            'name' => 'view-franchise-driver-profile',
            'description' => 'View franchise drivers Profile',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'view-franchise-driver-profile',
        ],
        PermissionSlug::FRANCHISE_DRIVER_APPROVAL => [
            'name' => 'franchise-driver-approval',
            'description' => 'franchise drivers approval',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'franchise-driver-approval',
        ],
        PermissionSlug::FRANCHISE_DRIVER_DISAPPROVAL => [
            'name' => 'franchise-driver-disapproval',
            'description' => 'franchise-drivers disapproval',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'franchise-driver-disapproval',
        ],
        PermissionSlug::FRANCHISE_DRIVER_UPLOAD_DOCUMENTS => [
            'name' => 'franchise-driver-upload-documents',
            'description' => 'franchise drivers documents upload',
            'main_menu'=>'franchise-owner-management',
            'sub_menu'=>null,
            'main_link'=>'franchise-driver-upload-documents',
        ],
        PermissionSlug::MANAGE_FRANCHISE_DRIVERS =>[
            'name' => 'manage-franchise-drivers',
            'description' => 'manage franchise drivers',
            'main_menu'=>'manage-franchise-drivers',
            'sub_menu'=>null,
            'main_link'=>'manage-franchise-drivers',
        ],
        PermissionSlug::FRANCHISE_WALLET=> [
            'name' => 'franchise-wallet',
            'description' => 'franchise wallet',
            'main_menu' => 'franchise wallet',
            'sub_menu' => null,
            'main_link' => 'franchise wallet',
        ],
        PermissionSlug::FRANCHISE_WITHDRAWAL_REQUEST=> [
            'name' => 'franchise-withdrawal-request',
            'description' => 'franchise withdrawal request',
            'main_menu' => 'franchise withdrawal request',
            'sub_menu' => null,
            'main_link' => 'franchise withdrawal request',
        ],
         PermissionSlug::FRANCHISE_WITHDRAWAL=> [
            'name' => 'withdrawal-franchise',
            'description' => 'franchise withdrawal ',
            'main_menu' => 'franchise withdrawal ',
            'sub_menu' => null,
            'main_link' => 'franchise withdrawal ',
        ],
         PermissionSlug::MANAGE_FRANCHISE_PROMO => [
            'name' => 'manage-franchise-promo',
            'description' => 'View Franchise Promo code',
            'main_menu'=>'manage-franchise-promo',
            'sub_menu'=> null,
            'main_link'=>'manage franchise promo',
        ],
        PermissionSlug::ADD_FRANCHISE_PROMO  => [
            'name' => 'add-franchise-promo',
            'description' => 'add Franchise Promo code',
            'main_menu'=>'manage-franchise-promo',
            'sub_menu'=> null,
            'sub_link'=>null,
            'main_link'=>'add-franchise-promo',
        ],
        PermissionSlug::EDIT_FRANCHISE_PROMO => [
            'name' => 'edit-franchise-promo',
            'description' => 'edit Franchise promo',
            'main_menu'=>'manage-franchise-promo',
            'main_link'=>'edit-franchise-promo',
        ],  
        PermissionSlug::DELETE_FRANCHISE_PROMO => [
            'name' => 'delete-franchise-promo',
            'description' => 'delete franchise promo',
            'main_menu'=>'manage-franchise-promo',
            'main_link'=>'delete-franchise-promo',    
        ],  
        PermissionSlug::TOGGLE_FRANCHISE_PROMO => [
            'name' => 'toggle-franchise-promo',
            'description' => 'toggle-franchise-promo',
            'main_menu'=>'manage-franchise-promo',
            'main_link'=>'toggle-franchise-promo',
        ],
        PermissionSlug::VIEW_FRANCHISE_PROMO => [
            'name' => 'view-franchise-promo',
            'description' => 'view-franchise-promo',
            'main_menu'=>'manage-franchise-promo',
            'main_link'=>'view-franchise-promo',
        ],
        PermissionSlug::WALLET_PAYMENT=> [
            'name' => 'wallet-payment',
            'description' => 'wallet payment',
            'main_menu' => 'wallet payment',
            'sub_menu' => null,
            'main_link' => 'wallet payment',
        ],
        PermissionSlug::FRANCHISE_ADDONS => [
            'name' => 'franchise_addons',
            'description' => 'franchise Addons',
            'main_menu'=>'addons',
            'sub_menu'=> null,
            'main_link'=>'franchise_addons',
        ],
           /* franchise owner management */
        PermissionSlug::FRANCHISE_OWNER_MANAGEMENT => [
            'name' => 'franchise-owner-management',
...
// Manage franchise Owner Needed Doc
        ...
        PermissionSlug::FRANCHISE_ADDONS => [
         ...
         PermissionSlug::SINGLE_LANDING_HOME => [
            'name' => 'single_landing_page',
            'description' => 'Single landing page',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-landingpage',
        ],
        PermissionSlug::ADD_SINGLE_LANDING_HOME => [
            'name' => 'add_single_landing_page',
            'description' => 'Add Single landing page',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-landingpage',
        ],       
        PermissionSlug::EDIT_SINGLE_LANDING_HOME=> [
            'name' => 'edit_single_landing_page',
            'description' => 'Edit Single landing page',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-landingpage',
        ],       
        PermissionSlug::DELETE_SINGLE_LANDING_HOME => [
            'name' => 'delete_single_landing_page',
            'description' => 'Delete Single landing page',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-landingpage',
        ],
        /* header-footer */
        PermissionSlug::SINGLE_HEADER_FOOTER => [
            'name' => 'single_header_footer',
            'description' => 'header footer',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-header-footer',
        ],
        PermissionSlug::SINGLE_ADD_HEADER_FOOTER => [
            'name' => 'single_add_header_footer',
            'description' => 'Add header footer',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-header-footer',
        ],       
        PermissionSlug::SINGLE_EDIT_HEADER_FOOTER=> [
            'name' => 'single_edit_header_footer',
            'description' => 'Edit header footer',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-header-footer',
        ],       
        PermissionSlug::SINGLE_DELETE_HEADER_FOOTER => [
            'name' => 'single_delete_header_footer',
            'description' => 'Delete header footer',
            'main_menu'=>'cms-landing-website',
            'sub_menu'=> null,
            'main_link'=>'single-header-footer',
    ...
    protected $roles = [
       ...
       RoleSlug::AGENT=>[
            'name' => 'agent',
            'description' => 'Taxi Agent user with standard access',
            'permissions' => [
               PermissionSlug::AGENT_DASHBOARD,                
                PermissionSlug::AGENT_RIDE,
                PermissionSlug::AGENT_RIDE_REQUEST ,
        ...
        RoleSlug::FRANCHISE_OWNER=>[
            'name' => 'Franchise Owner',
            'description' => 'Franchise Owner with standard access',
            'permissions' => [
                PermissionSlug::FRANCHISE_OWNER_MANAGEMENT,
                PermissionSlug::ACCESS_FRANCHISE_OWNER_DASHBOARD,
                PermissionSlug::MANAGE_FRANCHISE_DETAIL,
