...
//firebase setting
        ...
        //     'module' => 'payment',
        //    ],
        //    ['name' => 'airtel_test_client_id',
        //     'module' => 'payment','value' => 'Enter Airtel Test Client Id',
        //    ],
        //    ['name' => 'airtel_test_client_secret_key',
        //     'module' => 'payment','value' => 'Enter Airtel Test Client Secret Key',
        //    ],
        //    ['name' => 'airtel_live_client_id',
        //     'module' => 'payment','value' => 'Enter Airtel Live Client Id',
        //    ],
        //    ['name' => 'airtel_live_client_secret_key',
        //     'module' => 'payment','value' => 'Enter Airtel Live Client Secret Key',
        //    ],
        // kudi               
        ['name' => 'enable_kudi_sms_api_key',
            'value' => '0',
            'module' => 'sms',
        ],
        ['name' => 'kudi_sms_sender_id',
            'value' => 'Your Kudi Sender ID',
            'module' => 'sms',
        ],
        ['name' => 'kudi_sms_api_key',
            'value' => 'Your Kudi Api Key',
            'module' => 'sms',
        ],
        //paypal
        [
        ...
        ['name' => 'fedapay_environment',
            'value' => 'test',
            'module' => 'payment',
        ],
        ['name' => 'fedapay_test_secret_key',
            'value' => 'Enter Fedapay Test Secret Key',
            'module' => 'payment',
        ],
        ['name' => 'fedapay_live_secret_key',
            'value' => 'Enter Fedapay Live Secret Key',
            'module' => 'payment',
        ],
        // sslcommerz
        ...
        ['name' => 'sslcommerz_environment',
            'value' => 'test',
            'module' => 'payment',
        ],
        ['name' => 'sslcommerz_store_id',
            'value' => 'Enter SSLCOMMERZ Store ID',
            'module' => 'payment',
        ],
        ['name' => 'sslcommerz_store_password',
            'value' => 'Enter SSLCOMMERZ Store Password',
            'module' => 'payment',
        ],
    ];
