...
class AppModulesSeeder extends Seeder
{
    ...
    protected $app_modules = [
        ...
        [   'name' => 'Bidding',
            'transport_type' => 'taxi',
            'service_type' => 'bidding',
            'order_by' => '7',
            'short_description' => 'Bidding Taxi',
            'description' => 'Bidding Taxi',
            'mobile_menu_icon' => 'taxi-bidding.png',
            'active' => 1,
        ],
        ...
        [   'name' => 'Shared Ride',
            ...
            'order_by' => '10',
            'short_description' => 'Taxi Shared Ride',
            'description' => 'Taxi Shared Ride',
            'mobile_menu_icon' => 'shared-ride.png',
            'active' => 1,
        ],
        [   'name' => 'Outstation Shared Ride',
            'transport_type' => 'taxi',
            'service_type' => 'shared_ride',
            'order_by' => '11',
            'short_description' => 'Taxi Shared Ride',
