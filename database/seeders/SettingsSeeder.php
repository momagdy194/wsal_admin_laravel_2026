    ...
    //     ],  
      ...
      /*Mailer Name*/
       ...
       SettingSlug::ADMIN_LOGIN => [
        ...
        SettingSlug::DISPATCHER_LOGIN_PRO => [
         'category'=>SettingCategory::GENERAL,
         'value' => 'dispatch-pro',
         'field' => SettingValueType::TEXT,
         'option_value' => null,
        ...
        SettingSlug::DISTANCE_FOR_SECOND_RIDE => [
         ...
         SettingSlug::ENABLE_USER_REFERRAL => [
         ...
         SettingSlug::ENABLE_DRIVER_REFERRAL => [
            'category'=>SettingCategory::REFERRAL,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::REFERRAL_COMMISSION_FOR_USER => [
         ...
         SettingSlug::DISPATCHER_SIDEBAR_COLOR => [
            'category'=>SettingCategory::GENERAL,
            'value' => '#000000',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
         ...
         SettingSlug::DISPATCHER_SIDEBAR_TXT_COLOR => [
            'category'=>SettingCategory::GENERAL,
            'value' => '#000000',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
...
//user refrral settings
        SettingSlug::REFERRAL_TYPE => [
            'category'=>SettingCategory::REFERRAL,
            'value' => "instant",
            'field' => SettingValueType::SELECT,
            'option_value' => '{"instant":"instant","dual_instant":"dual_instant","conditional":"conditional","dual_conditional":"dual_conditional"}',
            'group_name' => null,
        ], 
        SettingSlug::REFERRAL_COMMISSION_FOR_NEW_USER_FROM_REFERER_USER => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::REFERRAL_COMMISSION_FOR_NEW_DRIVER_FROM_REFERER_USER => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::ENABLE_REFERRAL_CONDITION_BY_RIDE_COUNT => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
        ],
        
        // SettingSlug::ENABLE_EMAIL_LOGIN => [
        //     'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
        //     'value' => '1',
        //     'field' => SettingValueType::SELECT,
        //     'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_REFERRAL_CONDITION_BY_EARNING => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::REFERRAL_CONDITION_USER_RIDE_COUNT => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::REFERRAL_CONDITION_DRIVER_RIDE_COUNT => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::REFERRAL_CONDITION_USER_SPENT_AMOUNT => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::REFERRAL_CONDITION_DRIVER_EARNING_AMOUNT => [
            'category'=>SettingCategory::REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
...
// Driver Referral Settings //
        SettingSlug::DRIVER_REFERRAL_TYPE => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => "instant",
            'field' => SettingValueType::SELECT,
            'option_value' => '{"instant":"instant","dual_instant":"dual_instant","conditional":"conditional","dual_conditional":"dual_conditional"}',
            'group_name' => null,
        ], 
        SettingSlug::REFERRAL_COMMISSION_FOR_NEW_USER_FROM_REFERER_DRIVER => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::REFERRAL_COMMISSION_FOR_NEW_DRIVER_FROM_REFERER_DRIVER => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::ENABLE_DRIVER_REFERRAL_CONDITION_BY_RIDE_COUNT => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
        ],
        
        SettingSlug::ENABLE_DRIVER_REFERRAL_CONDITION_BY_EARNING => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::DRIVER_REFERRAL_CONDITION_USER_RIDE_COUNT => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_REFERRAL_CONDITION_DRIVER_RIDE_COUNT => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_REFERRAL_CONDITION_USER_SPENT_AMOUNT => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_REFERRAL_CONDITION_DRIVER_EARNING_AMOUNT => [
            'category'=>SettingCategory::DRIVER_REFERRAL,
            'value' => 0,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        //user sign-in
        SettingSlug::ENABLE_USER_SIGN_IN_EMAIL_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_USER_SIGN_IN_EMAIL_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_USER_SIGN_IN_MOBILE_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_USER_SIGN_IN_MOBILE_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        //user sign-up
        // SettingSlug::ENABLE_USER_SIGN_UP_EMAIL_OTP => [
        //     'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
        //     'value' => '1',
        //     'field' => SettingValueType::SELECT,
        //     'option_value' => '{"yes":1,"no":0}',
        //     'group_name' => null,
        // ],
        // SettingSlug::ENABLE_USER_SIGN_UP_EMAIL_PASSWORD => [
        //     'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
        //     'value' => '1',
        //     'field' => SettingValueType::SELECT,
        //     'option_value' => '{"yes":1,"no":0}',
        //     'group_name' => null,
        // ],
        // SettingSlug::ENABLE_USER_SIGN_UP_MOBILE_OTP => [
        //     'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
        //     'value' => '1',
        //     'field' => SettingValueType::SELECT,
        //     'option_value' => '{"yes":1,"no":0}',
        //     'group_name' => null,
        // ],
        // SettingSlug::ENABLE_USER_SIGN_UP_MOBILE_PASSWORD => [
        //     'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
        //     'value' => '1',
        //     'field' => SettingValueType::SELECT,
        //     'option_value' => '{"yes":1,"no":0}',
        ...
        // ],
        //driver sign-in
        SettingSlug::ENABLE_DRIVER_SIGN_IN_EMAIL_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_DRIVER_SIGN_IN_EMAIL_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_DRIVER_SIGN_IN_MOBILE_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_DRIVER_SIGN_IN_MOBILE_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        // driver sign-up
        SettingSlug::ENABLE_OWNER_SIGN_IN_EMAIL_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_OWNER_SIGN_IN_EMAIL_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_OWNER_SIGN_IN_MOBILE_OTP => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_OWNER_SIGN_IN_MOBILE_PASSWORD => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_USER_EMAIL_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_USER_MOBILE_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_DRIVER_EMAIL_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_DRIVER_MOBILE_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_OWNER_MOBILE_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::ENABLE_OWNER_EMAIL_LOGIN => [
            'category'=>SettingCategory::CUSTOMIZATION_SETTINGS,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::BIDDING_RIDE_MAXIMUM_DISTANCE => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 10,
            'field' => SettingValueType::TEXT,
            'option_value' => 0,
